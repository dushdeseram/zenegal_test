<div class="row purchace-popup">
    <div class="col-12 stretch-card grid-margin">
        <div class="card">
            ...
            <form method="POST"  id="formUpdateEmployee" class="lcs-form">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="inputEmloyeeId" name="employee_id" value="{{$employee->id}}" />
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#formUpdateEmployee").submit(function (event) {
            ...
            $.ajax({
                type:'POST',
                url: "{{URL::to('employee/updateemployeeprocess')}}",
