<div class="row purchace-popup">
    <div class="col-12 stretch-card grid-margin">
        <div class="card">
            ...
            <form method="POST"  id="formUpdateCompany" class="lcs-form">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="inputCompanyId" name="company_id" value="{{$company->id}}"/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="inputEmail" name="email" value="{{$company->email}}"/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputWebsite" name="website" value="{{$company->website}}"/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right">
                                <button type="submit" class="btn btn-success form-submit">Update</button>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#formUpdateCompany").submit(function (event) {
            ...
            $.ajax({
                type:'POST',
                url: "{{URL::to('company/updatecompanyprocess')}}",
